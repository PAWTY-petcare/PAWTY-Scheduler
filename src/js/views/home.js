 ...
 <div className="container">
   <div className="App">
	 ...
	 <div className="contactBut d-inline justify-content-sm-center">
	 			...
	 			<Link to="/schedule"><button className="btn-dark btn-lg"><i class="fa-solid fa-calendar-days"></i></button></Link>   <button className="btn-success btn-lg" data-bs-container="body" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="Bottom popover"><i className="fa-solid fa-phone">Test</i> </button>   <button className="btn-primary btn-lg"> <i class="fa-solid fa-envelope"></i></button>
</div>
<div className="scope-of-service">
  ...
  <div class="col-sm-3">
	...
	<img src={ShortProp} class="card-img-top" alt="short" />
      <div class="card-body">
        <h5 class="card-title">Airbnb & Short-term Rental Cleaning and Maintenence</h5>
